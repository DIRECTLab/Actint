...
from noiser import noise_coordinate
...
def main():
  ...
  visible_chance = argv_or_default(4, float, 0.95)
  invisible_chance = argv_or_default(5, float, 0.80)
  stay_visible_chance = argv_or_default(6, float, 0.80)
