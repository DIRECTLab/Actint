// READ: This component is deprecated for this app and may eventually be removved or repurposed.
// READ: This file can be used if we would like to add popups onto markers that can contain various information about the ship's satus's
// READ: The following can be used for future reference. (This is the code for the popup in the JFN config generator)
...
//   updateMarker: (index: number, LatLng: L.LatLng, height: any, speed: number,  error: number) => void;
...
//             <input 
//               type="number" id="speed" name="speed" defaultValue={previousValues.speed} onChange={(e) => {setPreviousValues( prev => ({...prev, speed: parseInt(e.target.value)})); updateMarker(index, marker.position.LatLng, marker.position.Z, parseInt(e.target.value), marker.error)}}
//               className="rounded border border-slate-300 p-1.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
//             />
//           </div>
...
//             <input 
//               type="number" id="error" name="error" defaultValue={previousValues.error} onChange={(e) => {setPreviousValues( prev => ({...prev, error: parseInt(e.target.value)})); updateMarker(index, marker.position.LatLng, marker.position.Z, marker.speed, parseInt(e.target.value))}}
//               className="rounded border border-slate-300 p-1.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
//             />
//           </div>
//         </div>
